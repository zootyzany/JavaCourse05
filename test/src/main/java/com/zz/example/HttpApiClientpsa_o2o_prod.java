...
public class HttpApiClientpsa_o2o_prod extends ApacheHttpClient {
    public final static String HOST = "gw.o2o.mpsa.cn";
    static HttpApiClientpsa_o2o_prod instance = new HttpApiClientpsa_o2o_prod();

    public static HttpApiClientpsa_o2o_prod getInstance() {
        return instance;
    }
